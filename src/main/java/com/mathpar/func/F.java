...
import com.mathpar.Graphic3D.Plot3D;
...
import com.mathpar.showgraph.PaintGraph;
...
public class F extends Element implements Cloneable {
    ...
    public final static int MAX = 195; //  максимальное из двух чисел:  max(a,b)
    public final static int MIN = 196; //  минимальное из двух чисел: min(a,b)
    ...
    //   область двух переменных:
    public final static int DIVREM = 197; //  целая часть частного b остаток при делении двух целых чисел
    public final static int DIV = 198; // целая часть частного при делении двух целых чисел
    public final static int REM = 199; // остаток при делении двух целых чисел
    public final static int MOD = 200; //  остаток от деления двух целых чисел в интервале 0 до MOD-1
    public final static int MODCENTERED = 201; //  остаток от деления двух целых чисел в интервале -(MOD-1)/2 до (MOD-1)/2
    public final static int ARG = 41; // argument of complex number \pi >=arg(x)> -\pi
    public final static int MODINVERSE = 202; //  обратное в простом поле по основанию m: a*modInsere(a,m)=1 mod m.
 ...
 //-------------------------------------------------------------------------
    ...
    public final static int B_NE = 168;  // не равно (инфиксное)
    public final static int FIRST_INFIX_NAME = 168;  //# первое инфиксное имя ####### 
    public final static int FIRST_INEQUAL_BOOL = 168; //# первая булева функция #########
    public final static int B_LESS = 169; // меньше 
    public final static int B_LE = 170; // меньше либо равно 
    public final static int B_EQ = 171; // равно 
    public final static int B_GE = 172; // больше либо равно 
    public final static int B_GT = 173; // больше 
    public final static int LAST_INEQUAL_BOOL = 173; //# последняя булева функция сравнения чисел 
     public final static int B_IMPLIES = 174;  // logical IMPLIES (инфиксное)
     public final static int B_EQUIV = 175;  // logical  EQUIVALENT (инфиксное)//  \Leftrightarrow
    //% Oбщие алгебраические операции
    public final static int FIRST_WB = 176;//  те кто не требуют \ в первой поз
    ...
    public final static int LAST_FUNC_TWO_ARGS = SET_MINUS;
    ...
    //MAX,MIN,  MODINVERSE = 195-202
 

    // многих переменных
    //% Графические функции, печать выражений
    public final static int FIRST_FUNC_MANY_ARGS = 203; //# первая функция с переменным числом аргументов
    public final static int PAINTELEMENT = 223; // функция для планиметрических построений, понимающая команды
...
//%  Параллельная компьютерная алгебра (в стадии разработки)
    ...
    public final static int SHOW_PLOTS_3D = 419; // show multiple 3d plots on one plane
    public final static int SET3D = 420;
    public final static int SHOW_PLOTS_3D_INTERSECTION = 421; // show multiple 3d plots on one plane
    public final static int FUNC_ARR_LEN = 422; //?  490; //# общее  число функций в проекте
    ...
    public static final HashMap<String, Integer> strMap = new HashMap<String, Integer>();
    ...
    static {
        ...
        FUNC_NAMES[MODINVERSE] = "modInverse";
        ...
        FUNC_NAMES[B_NE] = "ne";  //not equal
        FUNC_NAMES[B_IMPLIES] = "implies"; // first boolean operator
        FUNC_NAMES[B_EQUIV] =  "Leftrightarrow";
...
//        FUNC_NAMES[DEFINITION] = "definition";
   ...
   //     FUNC_NAMES[SOLVEHDE] = "solveHDE";
        ...
        FUNC_NAMES[SHOW_PLOTS_3D] = "showPlots3D";
        FUNC_NAMES[SHOW_PLOTS_3D_INTERSECTION] = "intersection3D";
...
//        boolean expandFlag = ((key & 1) == 1);
    ...
    public static int getArgsNum(int name) {
        ...
        if (name >= FIRST_FUNC_TWO_ARGS && name <= LAST_FUNC_TWO_ARGS) {
            return 2;
        }
        return 0;
    }
    ...
    public void showPlots(Page page, Element[] arrParam, boolean parcaPort, String[] names) {
        ArrayList<Element> f_1 = new ArrayList<Element>();//for explisit functions
        ArrayList<Element> f_2 = new ArrayList<Element>();// for parametric functions
        ArrayList<Element> f_3 = new ArrayList<Element>(); //for table functions
        ArrayList<Element> f_4 = new ArrayList<Element>(); // pointsPlot
        ArrayList<Element> f_5 = new ArrayList<Element>();// pointsPlot
        ArrayList<Element> f_6 = new ArrayList<Element>();// pointsPlot
        ArrayList<Element> f_7 = new ArrayList<Element>();// pointsPlot
        ...
        Element[] tablePointsFuncs;//array for pointsPlot
        Element[] pointsText;//array for pointsPlot
        Element[] pointsK1;//array for  pointsPlot
        Element[] pointsK2;//array for pointsPlot
        double[][] xR = new double[][] {};//tables for X
        double[][] yR = new double[][] {};//tables for  Y
        ...
        if (X.length == 2 || X.length == 1) {
            if (((F) X[0]).name == F.VECTORS) {
                for (int i = 0; i < ((F) X[0]).X.length; i++) {
                    ...
                    Vector<Element> T = new Vector<Element>();//вектор параметров для параметрических функций unctions)(for the harametric functions)
                    Vector<Element> tables = new Vector<Element>();//вектор для табличных функций
                                                                   //(for the table fanctions)
                    Vector<Element> tablesPoints = new Vector<Element>();//vector for the pointsPlot
                    Vector<Element> text = new Vector<Element>();// vector for the pointsPlot
                    Vector<Element> k1 = new Vector<Element>();// vector for the pointsPlot
                    Vector<Element> k2 = new Vector<Element>();// vector for the pointsPlot
                    Vector<Element[]> vS = new Vector<Element[]>();//vector for the textPlot
                    ...
                    switch (f_input.name) {
                        ...
                        case PLOT: {
                            if (f_input.X[0] instanceof VectorS) {
                                for (int i11 = 0; i11 < ((VectorS) f_input.X[0]).V.length; i11++) {
                                    nameFunc.add(names[i] + "_" + i11);
                                }
                            } else {
                        ...
                        case TABLEPLOT: {
                            int length=0;
                            if(f_input.X[0] instanceof VectorS) length =((VectorS) f_input.X[0]).V.length;
                            else if( f_input.X[0] instanceof MatrixD) length =((MatrixD) f_input.X[0]).M.length;
                            ...
                            if (length == 2) {
                                nameTableFunc.add(names[i]);
                                    ...
                                    for (int i11 = 0; i11 < length - 1; i11++) {
                                        nameTableFunc.add(names[i] + "_" + i11);
                                    }
                                }
                            } else {
                                nameTableFunc.add("");
...
//        }
    ...
    public NumberZ64 booleanFunction(Ring ring) {
        ...
        switch (this.name) {
            ...
            case B_NOT:
                return temp[0].B_NOT();
            case B_IMPLIES:
                return temp[0].B_IMPLIES(temp[1]);
            case B_EQUIV:
                return temp[0].B_EQUIV(temp[1]);
        }
        return TRUE;
    }
    ...
    public static Element cleanOfRepeating(Element node, Ring ring) {
        ...
        if (node instanceof F) {
            ...
            f_node.X = ((F) node).X;
            int len = f_node.X.length;      
//          if(f_node.name==F.DIVIDE){if (((f_node.X[1]).isItNumber(ring))&&(!(f_node.X[0]).isItNumber(ring))){
//                        Element ttemp=ring.numberONE.divideToFraction(f_node.X[1], ring);
//                        f_node.X[1]=f_node.X[0]; f_node.X[0]=ttemp;
//                        f_node.name=F.MULTIPLY; ((F) node).name= F.MULTIPLY;     }}
           int f_name = f_node.name;  
            for (int i = 0; i < len; i++) {
                if (f_node.X[i] != null) {
                    ((F) node).X[i] = cleanOfRepeating(f_node.X[i], ring);
                }
            }
            if (vectF[f_node.name] == null) { vectF[f_node.name] = new Vector<F>(); }
            if ((f_name >= F.FIRST_INFIX_COMMUT_ARG) && (f_name <= F.LAST_INFIX_COMMUT_ARG)) { //дольем аргументов
                int addArg=0;
                for (Element X1 : f_node.X) {
                    if ((X1 instanceof F) && (((F) X1).name == f_name)) {addArg += ((F) X1).X.length-1;} }
                if(addArg!=0){  addArg+=f_node.X.length;   Element[] ee=new Element[addArg]; int pp=0;
                   for (int i = 0; i < f_node.X.length; i++) { 
                     if((f_node.X[i] instanceof F)&&(((F)f_node.X[i]).name==f_name)){
                        for (int j = 0; j < ((F)(f_node.X[i])).X.length; j++) ee[pp++]=((F)(f_node.X[i])).X[j];}else ee[pp++]=f_node.X[i];
                   }   f_node.X=ee;
                }
            }
            len=f_node.X.length;
            for (F f : vectF[f_node.name]) {
                if (len == f.X.length) {
                    ...
                    if ((f_name >= F.FIRST_INFIX_COMMUT_ARG) && (f_name <= F.LAST_INFIX_COMMUT_ARG)) {
                        int[] eq = new int[len];
                        int pos = len;
                        for (int j = 0; j < pos; j++)  eq[j] = j;
                        search:
                        for (int j = 0; j < len; j++) {
                            for (int j1 = 0; j1 < pos; j1++) {
                                if ((f_node.X[j] == XX[eq[j1]])) {
                                    eq[j1] = eq[--pos]; continue search; }
                            }
                            equalsF = false;  break search;
                        }
                    } else {
                        for (int j = 0; j < len; j++) {
                            if (f_node.X[j] != XX[j]) { equalsF = false; break; }
                        }
                    }
                    if (equalsF) { return f; }
                }
    ...
    public Element valueOf(Ring ring) {
        return new FvalOf(ring).valOf(this, new Element[0]);
    }

    public Element valueOf(Element[] point, Ring ring) {
        return new FvalOf(ring).valOf(this, point);
    }
    ...
    public Element D(int num, Ring ring) {
        switch (name) {
            ...
            case TH:
                F THd = new F(DIVIDE, new Element[] {ring.numberONE, new F(POW, new Element[] {new F(CH, X[0]), ring.numberONE.valOf(2, ring)})});
                Element DTH = X[0].D(num, ring);
                return (DTH.isZero(ring)) ? ring.numberZERO : THd.multiply(DTH, ring);
            case CTH:
                F CTHd = new F(DIVIDE, new Element[] {ring.numberMINUS_ONE, new F(POW, new Element[] {new F(SH, X[0]), ring.numberONE.valOf(2, ring)})});
                Element DCTH = X[0].D(num, ring);
                return (DCTH.isZero(ring)) ? ring.numberZERO : CTHd.multiply(DCTH, ring);
            case ARCSH:
                F ASHsq = new F(SQRT, new F(ADD, new Element[] {ring.numberONE, new F(POW, new Element[] {X[0], ring.numberONE.valOf(2, ring)})}));
                F ASHd = new F(DIVIDE, new Element[] {ring.numberONE, ASHsq});
                Element DARCSINH = X[0].D(num, ring);
                return (DARCSINH.isZero(ring)) ? ring.numberZERO : ASHd.multiply(DARCSINH, ring);
            case ARCCH:
                F ACHsq = new F(SQRT, new F(SUBTRACT, new Element[] {new F(POW, new Element[] {X[0], ring.numberONE.valOf(2, ring)}), ring.numberONE}));
                F ACHd = new F(DIVIDE, new Element[] {ring.numberONE, ACHsq});
                Element DARCCOSH = X[0].D(num, ring);
                return (DARCCOSH.isZero(ring)) ? ring.numberZERO : ACHd.multiply(DARCCOSH, ring);
            case ARCTGH:
                F ATHa = new F(SUBTRACT, new Element[] {ring.numberONE, new F(POW, new Element[] {X[0], ring.numberONE.valOf(2, ring)})});
                F ATHd = new F(DIVIDE, new Element[] {ring.numberONE, ATHa});
                Element DARCTGH = X[0].D(num, ring);
                return (DARCTGH.isZero(ring)) ? ring.numberZERO : ATHd.multiply(DARCTGH, ring);
            case ARCCTGH:
                F ATCHa = new F(SUBTRACT, new Element[] {ring.numberONE, new F(POW, new Element[] {X[0], ring.numberONE.valOf(2, ring)})});
                F ATCHd = new F(DIVIDE, new Element[] {ring.numberONE, ATCHa});
            ...
            case INT: {
                if( (ring.varPolynom.length > num)&&(X[1].subtract(ring.varPolynom[num], ring).isZero(ring)) ) {
                    return X[0];
                }
            }
        }
...
//        }
    ...
    public Element subtract(Element f, Ring ring) {
        if (isZero(ring))     return f.negate(ring);
        if (f.isZero(ring))   return this;
...
//                    }
                ...
                case VECTORS:
                    res.append("[");
                    if(X.length>0){ res.append(X[0] == null ? "?" : X[0].toString(r));}                
                    for (int i = 1; i < X.length; i++) {
                        res.append(',').append(X[i] == null ? "?" : X[i].toString(r));
                    }
                        ...
                        if ((name == SYSTLDE || name == INITCOND || name == EQUATION || name == SOLVE) && (i % 2 == 0)) {
                            ...
                            if (!(X[i].numbElementType()<=Ring.Polynom)) {
                                ...
                                if (isInfix) {
                                    ...
                                    infNa = (name==MULTIPLY)||(name==ADD)||(name==DIVIDE)||(name==SUBTRACT) ? " " + infNa + " ": " \\" + infNa + " " ;
                                }
    ...
    public F toComplex(Ring ring) {
        ...
        switch (name) {
            case COS:
                return simplifyTrig_andExp_andLog.transformCos(X[0], ring);
            case SIN:
                return simplifyTrig_andExp_andLog.transformSin(X[0], ring);
            case CTG:
                return simplifyTrig_andExp_andLog.transformCtg(X[0], ring);
            case TG:
                return simplifyTrig_andExp_andLog.transformTg(X[0], ring);
            case CH:
                return simplifyTrig_andExp_andLog.transformCH(X[0], ring);
            case SH:
                return simplifyTrig_andExp_andLog.transformSH(X[0], ring);
            case TH:
                return simplifyTrig_andExp_andLog.transformTH(X[0], ring);
            case CTH:
                return simplifyTrig_andExp_andLog.transformCTH(X[0], ring);
            case ARCCOS:
                return simplifyTrig_andExp_andLog.transformArccos(X[0], ring);
            case ARCSIN:
                return simplifyTrig_andExp_andLog.transformArcsin(X[0], ring);
            case ARCTG:
                return simplifyTrig_andExp_andLog.transformArctg(X[0], ring);
            case ARCCTG:
                return simplifyTrig_andExp_andLog.transformArcctg(X[0], ring);
            case ARCCSC:
                return simplifyTrig_andExp_andLog.transformArccsc(X[0], ring);
            case ARCSEC:
                return simplifyTrig_andExp_andLog.transformArcsec(X[0], ring);
        }
        return this;
    }
    ...
    public Element arcsn(Ring ring) {
        ...
        if (temp_res instanceof F) {
            return new FuncNumberQZ(ring).arc_trigFunc_Rad(temp_res, F.SIN, ring);
        }
    ...
    public Element arccs(Ring ring) {
        Element temp_res = this.expand(ring);
        if (temp_res instanceof F) {
            return new FuncNumberQZ(ring).arc_trigFunc_Rad(temp_res, F.COS, ring);
        }
    ...
    public Element arctn(Ring ring) {
        Element temp_res = this.expand(ring);
        if (temp_res instanceof F) {
            return new FuncNumberQZ(ring).arc_trigFunc_Rad(temp_res, F.TG, ring);
        }
    ...
    public Element arcctn(Ring ring) {
        Element temp_res = this.expand(ring);
        if (temp_res instanceof F) {
            return new FuncNumberQZ(ring).arc_trigFunc_Rad(temp_res, F.CTG, ring);
        }
    ...
    public Element factorLnExp(Ring ring) {
        ...
        FactorPol res = new LN_EXP_POW_LOG_LG().factorLogExpHead(fp, 0, ring);
    ...
    public Element expandLn(Ring ring) {
        return new LN_EXP_POW_LOG_LG().expandLog(this, ring);
    }
    ...
    public Element Factor(boolean doNewVect, Ring ring) { 
        Element func = LN_EXP_POW_LOG_LG.logIdentity(this, ring);
        func = LN_EXP_POW_LOG_LG.powIdentity(func, ring);
        func = LN_EXP_POW_LOG_LG.deleteInverseFuncs(func, ring);
        if( (func instanceof F) == false) {
            return func;
        }
        Element[] f = ((F)func).factorPlusPolynom(doNewVect, ring);
        if (f[1] == null) { return this; }
        Element res = LN_EXP_POW_LOG_LG.fullFactor(f, 1, ring);// pol OR Fract OR factPol
        return (res != null) ? ring.CForm.UnconvertAllLevels(res) : ring.CForm.UnconvertAllLevels(f[1]);
    }

    @Override
    public Element Expand(Ring ring) {
        Element res = LN_EXP_POW_LOG_LG.fullExpand(this, ring);
        return (res == null) ? this : res;
    }

    @Override
    public Element ExpandLog(Ring ring) {
        Element res = new LN_EXP_POW_LOG_LG().expandLog(this, ring);
        return (res == null) ? this : res;
    }

    @Override
    public Element ExpandTrig(Ring ring) {
        Element res = new TrigonometricExpand().ExpandTr(this, ring);
        return (res == null) ? this : res;
    }

    @Override
    public Element Simplify(Ring ring) {
        return LN_EXP_POW_LOG_LG.Simplify(this, ring);
    }
    ...
    private Element helpFullFactor1(Element el, Ring ring) {
        ...
        if (el instanceof Fraction) {
            return helpFullFactor(new F(DIVIDE, new Element[] {((Fraction) el).num, ((Fraction) el).denom}), ring);
        }
        if (el instanceof F) {    
        ...
        if (el instanceof F) {
            ...
            switch (((F) el).name) {
                ...
                case CTG:
                    ...
                    return new TrigonometricExpand().ExpandTr(new F(((F) el).name, arg), ring);
                case LN:
                case LG:
                    arg = helpFullExpand(X[0], ring);
                    return new LN_EXP_POW_LOG_LG().expandLog(new F(name, arg), ring);
                case LOG:
                    return helpFullExpand(new LN_EXP_POW_LOG_LG().expandLog(this, ring), ring);
                default:
                    Element[] NewArg = new Element[((F) el).X.length];
                    for (int i = 0; i < NewArg.length; i++) {
