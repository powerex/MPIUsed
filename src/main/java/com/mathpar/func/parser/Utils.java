 ...
 * !!! ADD HERE Al new operator   infix--Postfix
 * 1375 row with all infixPostfixOperations = {F.ADD, F.SUBTRACT, F.DIVIDE, F.MULTIPLY,....
 * 50 row at ParserStatic   !!!! ------------------------------
 */
final class Utils {
    /**
    ...
    static void getAllArgNumber(List<Token> tokens) {
        ...
        Integer[] infixPostfixOperations = {F.ADD, F.SUBTRACT, F.DIVIDE, F.MULTIPLY,
                ...
                F.B_NE, F.B_NOT, F.B_OR, F.B_IMPLIES, F.B_EQUIV,
