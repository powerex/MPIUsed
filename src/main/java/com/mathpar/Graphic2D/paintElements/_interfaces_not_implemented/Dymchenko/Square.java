...
public class Square {
	...
	Square(double size)
	{
		...
		points[1] = new Point(bottomLeft.x, bottomLeft.y + (double) size);
		
		points[2] = new Point(bottomLeft.x + (double) size, bottomLeft.y + (double) size);
		
		points[3] = new Point(bottomLeft.x + (double) size, bottomLeft.y);	
	}
	
	Square(double size, Point bottomLeft)
	{
		points[0] = new Point(bottomLeft.x, bottomLeft.y);
	...
	private static void codeToFile(String str) {
        File myFile = new File("SquareCreated");
        try {
