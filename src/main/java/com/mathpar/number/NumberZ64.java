...
//================================================================
    ...
    public NumberZ64 B_IMPLIES(NumberZ64 x) {
        return ((value == 1) & (x.value == 0)) ? FALSE : TRUE;
    }
    public NumberZ64 B_EQUIV(NumberZ64 x) {
        return ((value == 1) & (x.value == 1) | (value == 0) & (x.value == 0)) ? TRUE : FALSE;
    }
    /**
