...
public class Play_On_Ground { 
    public static void main(String[] args) throws Exception {
       ...
       "SPACE=R64[x, y];\n" +
               "\\set2D([-5,5,-4,4], ['абсцисы', 'ординаты', 'окружность'],[1, 1,12,1,0.5]);"+
               "p=\\paintElement('  Окружность = (центр ( 1,1, Ы ); радиус ( 2 ); касательная(42, 10);  сектор(45, 270); ) ' )  ;"
...
//     
  ...
  public  static void startDebug(String txt) throws Exception {
        ...
        String latex = page.strToTexStrMain(txt);
        ...
        System.out.println(page.ring.exception.length() != 0
                ...
                String latex1 = page.strToTexStrMain
        (page.data.section[0] + "\nout:\n"
                + page.data.section[1])
